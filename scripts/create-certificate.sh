...
PATH_ROOT_CNF="${PATH_SSL}/ca.jpa.$(hostname).cnf"
PATH_ROOT_CRT="${PATH_SSL}/ca.jpa.$(hostname).crt"
PATH_ROOT_KEY="${PATH_SSL}/ca.jpa.$(hostname).key"
